...
st.set_page_config(page_title="Macro Workstation", page_icon="📊", layout="wide")
...
st.markdown(
    ...
    <div class="dashboard-header">
      <div class="dashboard-heading">
        <div class="dashboard-eyebrow">GLOBAL MACRO · CROSS-ASSET · LIQUIDITY</div>
        <div class="dashboard-title">Macro Workstation</div>
        <div class="dashboard-subtitle">Rates · Liquidity · Risk · Cross-asset monitoring · 7×24 news</div>
      </div>
...
st.markdown('<div id="market-overview" class="section-anchor"></div><div class="section-kicker">MARKET TAPE</div>', unsafe_allow_html=True)
st.markdown('<div class="section-title">Market Overview</div><div class="section-description">US · Hong Kong · China major-index tape · 60-second quote refresh</div>', unsafe_allow_html=True)
...
st.markdown('<div class="section-title">Watchlist</div><div class="section-description">Cross-market instruments · multi-source quotes · 60-second refresh</div>', unsafe_allow_html=True)
