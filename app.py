...
def build_fig3(date_range):
    ...
    add_line(fig, data, "T10Y2Y", "10Y−2Y", 2.2, "dot", "y2", " bp"); add_line(fig, data, "T10Y3M", "10Y−3M", 2.2, "dash", "y2", " bp")
