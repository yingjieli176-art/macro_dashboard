...
st.markdown('<div class="section-title">市场概览</div><div class="section-description">主要指数行情带 · 当前价格 / 涨跌幅 / 市场状态 / 报价时间 · 60 秒刷新</div>', unsafe_allow_html=True)
...
st.markdown('<div class="section-title">自选观察</div><div class="section-description">核心标的快速监控 · 港/A/美股正常盘优先低延时多源行情 · Yahoo 仅备用或美股扩展时段 · 60 秒自动刷新</div>', unsafe_allow_html=True)
