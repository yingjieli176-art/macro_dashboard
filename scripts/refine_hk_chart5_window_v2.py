...
if normal_pos != -1:
    ...
    if desc_start != -1:
        desc_end = text.find("); add_sources([", desc_start)
        if desc_end != -1:
            ...
            text = text[:desc_start] + new_desc + text[desc_end + 1:]

if text != original:
    APP.write_text(text, encoding="utf-8")
    print("refined HK Chart 5 publication window v2")
else:
    print("HK Chart 5 publication window v2 already applied")
