...
text = text.replace('Aggregate Balance / Overnight HIBOR / 1M HIBOR', 'HK M2/M3 / Aggregate Balance / HIBOR / HKMA Rate Corridor / USD-HKD', 1)
text = text.replace('Aggregate Balance、隔夜 HIBOR 与 1M HIBOR', 'HK M2/M3、银行体系流动性、HIBOR、HKMA 利率走廊与 USD/HKD', 1)
text = text.replace('Aggregate Balance 是香港银行在金管局结算账户的总余额，用于观察香港银行体系流动性；HIBOR 用于观察港元银行间资金价格。', 'M2/M3 观察货币供应增长；Aggregate Balance 观察银行体系结算流动性；O/N、1M、3M HIBOR 与 HKMA Base Rate 观察港元资金价格及政策利率约束；USD/HKD 观察联系汇率压力。', 1)
